...
add_action( 'wp_enqueue_scripts', 'librairie_JQuery' );
	...
	function load_modale_js() {
		wp_enqueue_script('modale-js', get_stylesheet_directory_uri() . '/assets/js/modale.js', array('jquery'), '1.0.0', true);
	}
	add_action('wp_enqueue_scripts', 'load_modale_js');
